...
export const getAllEbooks = async (params = {}) => {
  const res = await axiosInstance.get("/ebooks", { params });
  return res.data;
};
...
export const createEbook = async (data) => {
  const res = await axiosInstance.post("/ebooks", data);
  return res.data;
};

export const updateEbook = async (id, data) => {
  const res = await axiosInstance.patch(`/ebooks/${id}`, data);
  return res.data;
};

export const deleteEbook = async (id) => {
  const res = await axiosInstance.delete(`/ebooks/${id}`);
  return res.data;
};